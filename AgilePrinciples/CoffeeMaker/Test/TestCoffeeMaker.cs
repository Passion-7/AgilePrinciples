...
namespace AgilePrinciples.CoffeeMaker.Test; 
...
internal class CoffeeMakerStub: CoffeeMakerAPI {
    ...
    public void SetBoilerButtonState(BoilerState boilerState) {
...
public class TestCoffeMaker {
    ...
    [Test]
    public void PotRemoveWhileNotEmptyAndReplacedEmpty() {
        NormalFill();
        api.potPresent = false;
        Poll();
        Assert.IsFalse(api.boilerOn);
